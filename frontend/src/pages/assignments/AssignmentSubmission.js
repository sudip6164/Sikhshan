  ...
  return (
    <div className="container mx-auto px-4 py-6">
      ...
      {getFilteredAssignments().map((assignment) => (
        <div key={assignment.id} className="bg-white rounded-lg shadow-md overflow-hidden mb-4">
          <div className="p-6">
              ...
              {assignment.status === "completed" ? (
                <div className="space-y-2">
                  ...
                  <Link
                    ...
                    className="w-full flex justify-center py-2 px-4 border border-red-500 rounded-md shadow-sm text-sm font-medium text-red-600 hover:bg-red-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                  >
                    View Details
                  </Link>
                </div>
